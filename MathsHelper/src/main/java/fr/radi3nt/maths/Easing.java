...
public interface Easing {
     ...
     */
    Easing SINE_IN = (t, b, c, d) -> -c * (float) FastTrig.cos(t / d * (Math.PI / 2)) + c + b;

    /**
     * Sinusoidal easing out - decelerating to zero velocity.
     */
    Easing SINE_OUT = (t, b, c, d) -> c * (float) FastTrig.sin(t / d * (Math.PI / 2)) + b;

    /**
     * Sinusoidal easing in/out - accelerating until halfway, then decelerating.
     */
    Easing SINE_IN_OUT = (t, b, c, d) -> -c / 2 * ((float) FastTrig.cos(Math.PI * t / d) - 1) + b;
